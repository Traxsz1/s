...
function Update:Window(text, logo, keybind)
 ...
 if _G.Mode == "Th" then
    ...
    TextLabel.Text = "ภาษาไทยเวอร์ชั่นV2"
    TextLabel.TextColor3 = Color3.fromRGB(0, 86, 255)
    TextLabel.TextSize = 18.000
    TextLabel.TextWrapped = true
 elseif _G.Mode == "Vn" then
    Frame.Parent = Main
    Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Frame.BackgroundTransparency = 1.000
    Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
...
page1:Toggle("จุดโคมไฟ", _G.AutoHolyTorch, function(value)
...
page1:Toggle("ฟาร์มวัสดุ", AutoFarmMaterial, function(x)
    AutoFarmMaterial = x
    if x == false then
...
page2:Toggle("โจมตีเร็ว", _G.FastAttack, function(x)
    _G.FastAttack = value
end)
...
page13:Toggle("มองทะลุหาผลไม้ปีศาจ", _G.DevilFruitESP, function(value)
DevilFruitESP = value
end)
spawn(function()
...
page10:Button("เทเลพอร์ไปบนต้นไม้ใหญ่", function()
...
page14:Toggle("รีบเควสฆ่าฉลาม20ตัว", _G.QRepairBoat, function(value)
...
page15:Toggle("เทเลพอรตไปหาเกาะจิ้งจอก", _G.TptoKisuneIsland, function(value)
...
page12:Seperator("<<เปลีนเซิฟเวอร์>>")
page12:Button("ย้ายเซิฟไปเซิฟคนน้อย", function()
    Teleport()
end)
page12:Button("ย้ายเซิฟไปเซิฟคนเยอะ", function()
    Hop()
end)
