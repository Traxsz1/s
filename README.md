...
function Update:Window(text, logo, keybind)
    ...
    TextLabel.Text = "ViệtNam Version"
...
Time = page1:Label("..")
page1:Label("tên tài khoản : "..game.Players.LocalPlayer.DisplayName)
function UpdateTime()
local GameTime = math.floor(workspace.DistributedGameTime+0.5)
local Hour = math.floor(GameTime/(60^2))%24
local Minute = math.floor(GameTime/(60^1))%60
local Second = math.floor(GameTime/(60^0))%60
Time:Set("[thời gian chơi] : giờ : "..Hour.." phút : "..Minute.." thứ hai : "..Second)
end
...
page1:Label("Vào Discord để xem tin tức.")
    page1:Button("Sao chép liên kết Bất hòa",function()
        setclipboard("https://discord.gg/977JQXX82w")
    game:GetService("StarterGui"):SetCore("SendNotification",{Title = "VectorHub",Text = "Đã sao chép thành công",Icon = "rbxassetid://16129235054",Duration = 3})
end)

    page1:Toggle("Cấp trang trại", _G.Settings.AutoFarm, function(value)
        _G.AutoFarm = value
        ...
        page1:Toggle("chế độ an toàn", _G.Settings.SafeMode, function(value)
            _G.SafeMode = value
        ...
        if HealthPercent < 20 then
            Vec("<Color=Cyan>Chế độ an toàn hoạt động<Color=/>")  
        end
           spawn(function()
    ...
    page1:Toggle("trang trại gần nhất", _G.Settings.NeareastFarm, function(value)
    ...
    if World1 then
        page1:Toggle("Cấp độ trang trại nhanh 1-300", _G.AutoFarmFast, function(value)
            _G.AutoFarmFast = value
        end)
    end
    page1:Toggle("Dịch chuyển nhanh [đối với tất cả các dịch chuyển tức thời]", _G.BypassTP, function(value)
        _G.BypassTP = value
    end)    
    ...
    page1:Line()
    page1:Toggle("Trang trại hộp kho báu {Bay để thu thập}", _G.Settings.AutoFarmChest, function(value)
    ...
    page1:Toggle("Trang trại hộp kho báu {Nhanh: Rủi ro}", _G.ChestBypass, function(value)
...
if World1 then
page1:Label("trạng thái : biển 1")
page1:Toggle("Tự động đi đến biển thứ hai", _G.AutoNewWorld, function(value)
...
page1:Toggle("Tìm thanh kiếm Shanks", _G.AutoSaber , function(value)
    _G.AutoSaber  = value
    if value == false then
        task.wait()
        toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
page1:Toggle("Tìm cây chùy của Enel", _G.AutoPole, function(value)
    _G.AutoPole = value
    if value == false then
        task.wait()
        toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
page1:Toggle("Tự động mua kỹ năng Haki",_G.AutoBuyAbility, function(value)
...
elseif World2 then
page1:Label("trạng thái : biển 2")
page1:Toggle("Tự động đi tới biển thứ ba", _G.AutoThirdSea, function(value)
...
page1:Toggle("Tự động hoàn thành cấp độ thứ hai của bộ tộc",_G.Auto_Evo_Race_V2,function(value)
...
page1:Toggle("Tự động hoàn thành nhiệm vụ Batolomeo", _G.Settings.AutoBartiloQuest,function(value)
...
page1:Toggle("Tìm một chiếc áo choàng râu đen.",_G.AutoDarkCoat,function(value)
...
page1:Toggle("Tìm ngoại chất {Ectoplasm}",_G.AutoEctoplasm,function(value)
...
page1:Toggle("tấn công nhà máy",_G.AutoFactory,function(value)
...
page1:Toggle("Ba thanh kiếm kết hợp", _G.AutoTrueTriplKatana, function(value)
...
page1:Toggle("Tìm thanh kiếm Rengoku.", _G.AutoRengoku, function(value)
...
page1:Toggle("Tìm kính Doflamingo.", _G.AutoSwanGlasses,function(value)
...
if not _G.ER then                                                                    
elseif World3 then
page1:Label("trạng thái : World 3")
    page1:Toggle("Tập Haki cầu vồng", _G.AutoRainbowHaki,function(value)
...
page1:Line()
page1:Seperator("<<Ngọn đuốc>>")
page1:Toggle("Thắp ngọn đuốc", _G.AutoHolyTorch, function(value)
        ...
        while task.wait() do
            pcall(function()
                if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                    Elite_Hunter_Status:Set("trạng thái : 🟢") 
                else
                    Elite_Hunter_Status:Set("trạng thái : 🔴") 
                end
            end)
...
spawn(function()
    pcall(function()
        while task.wait() do
            EliteProgress:Set("Đã giết rồi. : " ..
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"))
        end
    end)
end)
page1:Seperator("<<โจร>>")
page1:Toggle("Tấn công Elite Hunter và tự động di chuyển máy chủ.",_G.AutoEliteHunterHop, function(value)
...
page1:Toggle("Tấn công Elite Hunter", _G.AutoEliteHunter,function(value)
...
page1:Toggle("Tự động tấn công kẻ trộm ở hòn đảo trung tâm.", _G.AutoCastleRaid, function(value)
...
page1:Seperator("<<xương>>")
local count_number = 0
local count_stack = page1:Label('xương : ' .. count_number, true)
spawn(function()
    while task.wait() do
        local boneStatus = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones", "Check")
        count_stack:Set('xương : ' .. boneStatus)
        wait(1) 
    end
end)

page1:Toggle("trang trại xương", _G.Settings.AutoFarmBone , function(value)
...
page1:Toggle("Nhận nhiệm vụ trong trang trại xương", _G.AceetpQuestBone, function(value)
    _G.AceetpQuestBone = value
end)

page1:Toggle("Trao đổi xương", _G.AutoRandomBone, function(value)
...
page1:Seperator("<<Mochi>>")  
local MobKilledLabel = page1:Label("Bạn phải giết thêm: Đang tải...", true)
spawn(function()
while true do
    pcall(function()
        ...
        if string.len(cakeStatus) == 88 then
            MobKilledLabel:Set("Bạn phải giết thêm : " .. string.sub(cakeStatus, 39, 41))
        elseif string.len(cakeStatus) == 87 then
            MobKilledLabel:Set("Bạn phải giết thêm : " .. string.sub(cakeStatus, 39, 40))
        elseif string.len(cakeStatus) == 86 then
            MobKilledLabel:Set("Bạn phải giết thêm : " .. string.sub(cakeStatus, 39, 39))
        else
            MobKilledLabel:Set("Katakuri được sinh ra...")
        end
    end)
    wait(1)
end
end)
page1:Toggle("Tấn công Katakuri", _G.AutoCakePrince ,function(value)
...
page1:Seperator("<<vật chất>>")  
page1:Dropdown("Chọn vật liệu",AllMaterial, function(value)
SelectModeMaterial = value
end)
page1:Toggle("Trang trại vật chất", AutoFarmMaterial, function(x)
    AutoFarmMaterial = x
    if x == false then
...
Vec("<Color=Cyan>Vector Hub đã được tải thành công<Color=/>")  
Vec("<Color=Cyan>Nếu có lỗi dịch thuật, lỗi có thể được báo cáo.<Color=/>")      
                                                     
page2:Seperator("⚙️")
Weapon = {"Melee","Sword","Fruit"}
page2:Dropdown("Chọn vũ khí",Weapon, function(value)
SelectWeapon = value
end)
task.spawn(function()
while wait() do
...
page2:Dropdown("Chọn phương pháp",Method, function(value)
    _G.Method = value
end)
    
page2:Slider("Khoảng cách từ",1,80,30,function(value)
...
page2:Toggle("Tấn công nhanh", _G.FastAttack, function(x)
    _G.FastAttack = value
end)
...
page2:Toggle("Tự động kích hoạt Haki", true, function(value)
_G.AutoHaki = value
end)
task.spawn(function()
    while task.wait() do
...
page2:Toggle("Tự động kích hoạt Haki quan sát.", true, function(value)
_G.AutoKen = value
end)
spawn(function()
    while wait() do
...
page2:Toggle("Màn hình trắng", false, function(value)
...
page2:Toggle("Màn hình đen", false, function(value)
...
page2:Toggle("Ẩn tin nhắn thông báo", false, function(value)
...
_G.Auto_CFrame = true
page2:Toggle("Ẩn thiệt hại",  true, function(value)
_G.Disdamage = value
DisabledDamage()
end)

page3:Seperator("📊")
page3:Dropdown("Chọn ngăn xếp sức mạnh",{"Melee","Defense","Sword","Gun","Fruit"},function(value)
    _G.SelectStats = value
end)

page3:Toggle("Sức mạnh tăng lên", _G.EnabledAutoStats, function(value)
...
page3:Toggle("Sức mạnh tăng lên Like kaitun", _G.AutoStatsKaitun, function(value)
...
page3:Toggle("Nhập mã", _G.EnabledAutoRedeemCode, function(value)
...
page3:Seperator("<<phong cách chiến đấu>>") 
...
page4:Button("Dịch chuyển ra biển 1", function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)

page4:Button("Dịch chuyển ra biển 2", function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

page4:Button("Dịch chuyển ra biển 3", function(value)
...
page4:Dropdown("Chọn một vị trí",TeleportTable, function(value)
_G.SelectLocalTeleport = value
end)

page4:Toggle("Dịch chuyển đến vị trí đã chọn.", _G.TeleportIsland,function(value)
...
page4:Button("Dừng dịch chuyển tức thời", function(value)
    toTarget(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
end)
page1:Seperator("<<Haki quan sát>>") 
...
page1:Toggle("Tăng cấp độ quan sát của Haki",_G.Settings.AutoObservation,function(value)
...
page1:Toggle("Tăng cấp độ quan sát của Haki Hop",_G.AutoObservation_Hop,function(value)
...
page1:Line()
page1:Seperator("<<Ông chủ>>") 
local Boss = {}
local BossName = page1:Dropdown("Chọn một ông chủ",Boss, function(value)
    _G.SelectBoss = value
end)
...
page1:Toggle("Trang trại Boss", _G.AutoFarmBoss, function(value)
...
page1:Toggle("Tất cả trang trại trùm", _G.AutoAllBoss, function(value)
...
page6:Seperator("✨")
_G.HealthMs = 25
page6:Toggle("trang trại súng", _G.Settings.AutoFarmGunMastery, function(value)
...
page6:Toggle("Trang trại trái ác quỷ", _G.Settings.AutoFarmFruitMastery, function(value)
...
page6:Slider("giết khi (%)",1,100,25,function(value)
    _G.HealthMs = value
end)

page6:Label("Danh sách kỹ năng")
page6:Toggle("Kỹ năng Z", _G.SkillZ, function(value)
_G.SkillZ = value
end)
page6:Toggle("Kỹ năng X", _G.SkillX, function(value)
_G.SkillX = value
end)

page6:Toggle("Kỹ năng C", _G.SkillC, function(value)
_G.SkillC = value
end)

page6:Toggle("Kỹ năng V", _G.SkillV, function(value)
_G.SkillV = value
end)

page6:Toggle("Kỹ năng F",_G.SkillF, function(value)
_G.SkillF = value
end)
...
page7:Toggle("hái trái ác quỷ",_G.Auto_Bring_Fruit , function(value)
     _G.Auto_Bring_Fruit  = value
end)
page7:Toggle("Trái ác quỷ ngẫu nhiên", _G.AutoBuyRandomFruits, function(value)
_G.AutoBuyRandomFruits = value
end)

page7:Button("Mở cửa hàng trái ác quỷ", function()
local args = {
    [1] = "GetFruits"
}
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
page7:Toggle("Bỏ trái ác quỷ vào túi của bạn.", _G.AutoStoreFruits, function(value)
...
page8:Dropdown("Chọn một ngục tối",SelectRaids, function(value)
    _G.SelectRaids = value
end)
page8:Toggle("Đi xuống ngục tối", _G.AutoRaids, function(value)
    _G.AutoRaids = value
    if value == false then
        task.wait()
        toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
page8:Toggle("Aura tiêu diệt quái vật xung quanh bạn.", _G.KillAura, function(value)
    _G.KillAura = value
end)
page8:Toggle("Tự động đi đến hòn đảo tiếp theo.", _G.AutoNextPlace, function(value)
    _G.AutoNextPlace = value
    if value == false then
        toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
    end
end)
page8:Toggle("Mua kỹ năng thức tỉnh trái ác quỷ", _G.AutoAwakened, function(value)
...
local PlayerDrop = page13:Dropdown("Chọn một người chơi",getplayers, function(value)
    SelectPlayer = value
end)
...
page13:Toggle("Dịch chuyển tức thời đến người chơi.", teleporttop, function(value)
    teleporttop = value
    if value == false then
        task.wait()
        toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
page13:Toggle("Nhìn trộm người chơi", SpectatePlys, function(value)
    SpectatePlys = value
...
page13:Toggle("súng imbot", false, function(value)
    Aimbot = value
end)
page13:Toggle("Kỹ năng aimbot", false, function(value)
    Skillaimbot = value
end)
...
page13:Seperator("<<nhìn xuyên qua>>")
page13:Toggle("ESP Người chơi", _G.ESPPlayer, function(value)
ESPPlayer = value
end)
spawn(function()
while task.wait() do
...
page13:Toggle("ESP hộp kho báu", _G.ChestEsp, function(value)
ChestESP = value
end)
spawn(function()
    while ChestESP do
...
page13:Toggle("ESP trái ác quỷ", _G.DevilFruitESP, function(value)
DevilFruitESP = value
end)
spawn(function()
...
page13:Toggle("ESP hoa", _G.FlowerESP, function(value)
FlowerESP = value
end)
spawn(function()
    while FlowerESP do
...
page13:Toggle("ESP hòn đảo", _G.IslandESP, function(value)
IslandESP = value
end)
spawn(function()
    while IslandESP do
...
page9:Toggle("Dịch chuyển đến một hòn đảo bí mật.",  _G.Settings.AutoMirageIsland, function(value)
_G.Mirage = value
...
page9:Toggle("Dịch chuyển đến một hòn đảo bí mật [Hop]", _G.Settings.MirageHop, function(value)
_G.MirageHop = value
...
page9:Toggle("ESP hòn đảo bí mật", _G.ESPMirageIsland, function(value)
    _G.ESPMirageIsland = value
    ESPMirageIsland()
end)

page9:Toggle("Dịch chuyển đến người bán trái ác quỷ trên hòn đảo bí mật.", _G.TPNPCDF, function(value)
    spawn(function()
        pcall(function()
        while wait() do
            if _G.TPNPCDF then
...
page9:Toggle("Dịch chuyển đến bánh răng.", _G.Settings.Auto_Gear, function(value)
    _G.Auto_Gear = value
...
page9:Toggle("nhìn lên mặt trăng", _G.LockMoon , function(value)
_G.LockMoon = value
LockMoon()
end)
...
page10:Toggle("Kích hoạt cuộc đua cấp ba",_G.AutoActiveRace,function(value)  
...
page10:Toggle("Kích hoạt cấp độ cạnh tranh thứ tư.",_G.AutoActiveRaceV4,function(value)  
...
page10:Button("Dịch chuyển đến cái cây lớn.", function()
...
page10:Button("Dịch chuyển đến đòn bẩy.", function()
    toTarget(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

page10:Button("Dịch chuyển đến Acient One", function()
    toTarget(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)

page10:Button("Dịch chuyển đến cổng Bộ lạc Cyborg.", function()
    toTarget(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
end)
page10:Button("Dịch chuyển đến Cổng Bộ tộc Tiên cá.", function()
    toTarget(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
end)
page10:Button("Dịch chuyển đến Cổng Glu.", function()
    toTarget(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
end)
page10:Button("Dịch chuyển đến cổng loài người.", function()
    toTarget(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
end)
page10:Button("Dịch chuyển đến cổng thỏ.", function()
    toTarget(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
end)
page10:Button("Dịch chuyển đến Cổng Skypiea.", function()
    toTarget(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
end)

page10:Seperator("<<Tự động đi qua trạm kiểm soát bộ lạc>>")

page10:Button("Tự động vượt qua trạm kiểm soát bộ lạc Skypiea.", function(t)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame
end)
page10:Button("Tự động vượt qua trạm kiểm soát bộ lạc Mink.", function(t)
...
page10:Button("Tự động vượt qua trạm kiểm soát bộ lạc Cybrog.", function(t)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, 300, 0)
end)
page10:Button("Dịch chuyển đến khu vực chiến đấu.", function()
    toTarget(CFrame.new(28766.681640625, 14967.1455078125, -164.13290405273438))
end)
page10:Button("Dịch chuyển đến nơi an toàn khi chiến đấu.", function()
...
game.Lighting.DescendantAdded:Connect(function(obj)
    ...
    page14:Seperator("🌊")
    page14:Toggle("Tiêu diệt quái vật sự kiện biển", _G.AutoEvent, function(value)
        _G.AutoEvent = value
        spawn(function()
            while wait() do 
...
page14:Toggle("Nhận nhiệm vụ tiêu diệt 20 con cá mập.", _G.QRepairBoat, function(value)
...
page14:Toggle("Báo chí sau khi giết chết 20 con cá mập.", _G.QRepairBoat2, function(value)
...
page14:Dropdown("Chọn một chiếc thuyền",AllBoat, function(value)
    AllBoat = value
end)  
...
page14:Toggle("mua một chiếc thuyền", _G.Bboat, function(value)
    _G.Bboat = value
...
page14:Dropdown("Chọn mực nước biển",   Seatable , function(value)
    _G.SelectLocalTeleportSea = value
end)

page14:Toggle("Dịch chuyển đến vùng biển đã chọn.", _G.TeleportSea, function(value)
...
page14:Toggle("Dừng thuyền", _G.stpboat, function(value)
    _G.stpboat = value
...
page14:Toggle("tăng tốc độ thuyền",_G.increaseboatspeed, function(value)
...
page14:Toggle("lái thuyền tự động",_G.AutoSail, function(value)
    _G.AutoSail = value
    while _G.AutoSail do task.wait(0)
    game:GetService("VirtualInputManager"):SendKeyEvent(true,Enum.KeyCode.W,false,game)
    end
end)
page14:Toggle("thuyền xuyên qua đá",_G.Nocliprock, function(value)
    _G.Nocliprock = value
    spawn(function()
            while wait() do
        ...
        page14:Button("bản đồ tươi sáng", function()
    FullBright()
end)
    ...
    while task.wait() do
        pcall(function()
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                FM:Set("5/5 🌕: trạng thái")
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
                FM:Set("4/5 🌖 : trạng thái")
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                FM:Set("3/5 🌗 : trạng thái")
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then
                FM:Set("2/5 🌘 : trạng thái")
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then
                FM:Set("1/5 🌘 : trạng thái")
            else
                FM:Set("0/5 🌘 : trạng thái")
            end
        end)
    end
end)

page15:Toggle("Dịch chuyển đến Đảo Fox.", _G.TptoKisuneIsland, function(value)
...
page15:Toggle("Thu thập những quả cầu lửa tinh thần.", _G.Ez, function(value)
    _G.Ez = value
    spawn(function()
        while _G.Ez do wait()
            pcall(function()
...
page11:Seperator("🛒")
page11:Label("Tự động mua")
page11:Toggle("Auto mua kiếm của Zoro.", _G.AutoBuyLegendarySword, function(value)
...
page11:Toggle("Auto mua kiếm của Zoro Hop", _G.Settings.AutoBuyLegendarySwordHop, function(value)
...
page11:Toggle("Tự động mua màu haki", _G.AutoBuyEnchanmentHaki, function(value)
...
page11:Toggle("Tự động mua màu haki Hop", _G.Settings.AutoBuyEnchanmentHakiHop, function(value)
...
page12:Button("Tham gia vào đội cướp biển", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam", "Pirates")
end)

page12:Button("Tham gia đội hải quân", function()
...
page12:Seperator("<<thay đổi máy chủ>>")
page12:Button("Di chuyển máy chủ đến một máy chủ ít đông đúc hơn.", function()
    Teleport()
end)
page12:Button("Di chuyển máy chủ đến máy chủ có nhiều người.", function()
    Hop()
end)

page12:Button("Đi đến máy chủ ban đầu.", function()
    local ts = game:GetService("TeleportService")
    local p = game.Players.LocalPlayer
    ts:Teleport(game.PlaceId, p)
end)
page12:Line()
page12:Button("Chụp ảnh Kaitun", function()
kaituncap()
end)
page12:Button("Thể hiện kỹ năng Thức tỉnh Trái ác quỷ của bạn.", function()
    local args = {
    [1] = "getAwakenedAbilities"
    }
...
page12:Button("Hiển thị biệt hiệu", function()
    local args = {
    [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
page12:Button("Hiển thị màu sắc Haki", function()
...
page12:Toggle("Loại bỏ sương mù",false,function(value)
    _G.Remove_Fog = value
    while wait() do
...
page12:Toggle("Tự động nhấp chuột",false,function(value)
    _G.click = value
        end)  
        spawn(function()
        game:GetService("RunService").RenderStepped:Connect(function()
    ...
    page12:Toggle("đi bộ trên mặt nước",fasle,function(value)
        _G.WalkWater = value
    end)
    spawn(function()
            while task.wait() do
...
page12:Toggle("Khả năng không giới hạn", false, function(value)
    _G.InfAbility = value
    InfAbility()
end)

page12:Toggle("Dash không giới hạn", _G.NoDashCooldown, function(value)
...
page12:Toggle("Geppo không giới hạn", _G.InfinitiesSkyJump, function(value)
